...
function setup() {
  let sz = 50;
  let sz_char = 27;
  gameboard.mainboard = new Sprite(resources["gameboard.jpg"].texture);
  gameboard.profPlum = new Sprite(resources["prof_plum.png"].texture);
  gameboard.profPlum.height = sz_char;
  gameboard.profPlum.width = sz_char;
  gameboard.mrsWhite = new Sprite(resources["mrs_white.png"].texture);
  gameboard.mrsWhite.height = sz_char;
  gameboard.mrsWhite.width = sz_char;
  gameboard.mrGreen = new Sprite(resources["mr_green.png"].texture);
  gameboard.mrGreen.height = sz_char;
  gameboard.mrGreen.width = sz_char;
  gameboard.mrsPeacock = new Sprite(resources["mrs_peacock.png"].texture);
  gameboard.mrsPeacock.height = sz_char;
  gameboard.mrsPeacock.width = sz_char;
  gameboard.colMustard = new Sprite(resources["col_mustard.png"].texture);
  gameboard.colMustard.height = sz_char;
  gameboard.colMustard.width = sz_char;
  gameboard.missScarlett = new Sprite(resources["miss_scarlett.png"].texture);
  ...
  let button_up = new Sprite(resources["mv_btn.png"].texture);
  ...
  let button_down = new Sprite(resources["mv_btn.png"].texture);
  ...
  let button_right = new Sprite(resources["mv_btn.png"].texture);
  ...
  let button_left = new Sprite(resources["mv_btn.png"].texture);
...
document.body.onload = resize_area;
